                    ...
                    <ul class="nav nav-pills nav-top navbar-right">
                                ...
                                <div class="message-body">
                                    <ul>
                                        <li>
                                            <a href="#" class="single-message">
                                                <div class="message-img">
                                                    <img src="{{asset('assets/img/msg-4.png')}}" alt="message" />
                                        ...
                                        <li>
                                            <a href="#" class="single-message">
                                                <div class="message-img">
                                                    <img src="{{asset('assets/img/msg-1.png')}}" alt="message" />
                                        ...
                                        <li>
                                            <a href="#" class="single-message">
                                                <div class="message-img">
                                                    <img src="{{asset('assets/img/msg-3.png')}}" alt="message" />
                                                    <span class="online-message"></span>
                                                </div>
                                                <div class="message-txt">
                                                    <h4>Emanual Doe</h4>
                                        ...
                                        <li>
                                            <a href="#" class="single-message">
                                                <div class="message-img">
                                                    <img src="{{asset('assets/img/msg-2.png')}}" alt="message" />
                        ...
                        <li class="dropdown">
                            <a class="dropdown-toggle profile-toggle" href="#" data-toggle="dropdown">
                                <img src="{{asset('assets/img/avatar.jpg')}}" class="profile-avator" alt="admin profile" />
